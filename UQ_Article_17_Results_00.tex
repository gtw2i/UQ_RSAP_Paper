...
\end{equation}
where $a = 0.5, b = 0.15, c = 0.333, d = 8, x \in [-1, 1]$. The initial state values were set to $x_0 = 0.8, \Delta_0 = 0.08$ and the fixed proposal widths were set to $\sigma_x = 0.1, \sigma_\Delta = 0.0008$. As discussed above, the parameters for RSAP were set to $\hat A_{t} = 0.1, \hat A_{w} = 10, r_{t} = 0.3, r_{w} = 0.3, n_1 = 2000, n_2 = 1000$.
\begin{figure}[!htb]
\minipage{0.33\textwidth}
...
\begin{equation}
	f(x) = \bigg( 20 - 20 \textrm{exp}\bigg( -0.2 \Big( \sum_{n=1}^{M} x_n^2/M \Big)^{0.5} \bigg) \bigg) + \bigg( e - \textrm{exp}\bigg( \sum_{n=1}^{M} \textrm{cos}(2 \pi x_n)/M \bigg) \bigg)
\end{equation}
