...
\minipage{0.5\textwidth}
	\includegraphics[width=\linewidth]{UQPlot_MCMCSteps_001D_00_AdaF.jpg}
\endminipage\hfill
\minipage{0.5\textwidth}
	\includegraphics[width=\linewidth]{UQPlot_MCMCSteps_001D_00_AdaT.jpg}
\endminipage\hfill
\caption{Plots of the cumulative convergence of Metropolis (left) and RSAP (right) on a 1D Gaussian. 100 steps per chain, 500 chains per width value.}
\end{figure}

\begin{figure}[!htb]
\minipage{0.5\textwidth}
	\includegraphics[width=\linewidth]{UQPlot_MCMCSteps_003D_00_AdaF.jpg}
\endminipage\hfill
\minipage{0.5\textwidth}
	\includegraphics[width=\linewidth]{UQPlot_MCMCSteps_003D_00_AdaT.jpg}
\endminipage\hfill
\caption{Plots of the cumulative convergence of Metropolis (left) and RSAP (right) on a 3D Gaussian. 500 steps per chain, 1000 chains per width value. Note the different vertical axis scale.}
\end{figure}
