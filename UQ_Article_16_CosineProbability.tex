...
\end{figure}
As can be seen, there is efficient mixing between the two modes in the region up until $n = n_1$. Once standard Metropolis begins to overtake the adaptive effects, the chain becomes stuck in whichever mode it was currently in.    THE COVERAGE OF THESE TWO STATES WILL BECOME EQUAL ASYMPTOTICALLY, BUT FOR A SMALL NUMBER OF STEPS, IT IS LIKELY TO RESULT IN UNEQUAL SAMPLING IN THIS FUNCTION....  JW
